    ...
    render() {
        return (
            <div>
                ...
                <form>
                    <label>Id</label>
                    <input type="text" ref={this.cajaId} defaultValue={this.props.id} className='form-control' disabled />
                    <label>Nombre</label>
                    ...
                    <button onClick={this.updateDepartamento} className='btn btn-dark'>Update</button>
                </form>
            </div>
        )
    }
